...
/**
 * @title MoleCity's MBep20Delegator Contract
 * @notice MTokens which wrap an EIP-20 underlying and delegate to an implementation
 * @author MoleCity
 */
contract MBep20Delegator is MTokenInterface, MBep20Interface, MDelegatorInterface {
    /**
    ...
    function _setImplementation(address implementation_, bool allowResign, bytes memory becomeImplementationData) public {
        require(msg.sender == admin, "MBep20Delegator::_setImplementation: Caller must be admin");
   ...
   /**
    ...
    function () external payable {
        require(msg.value == 0,"MBep20Delegator:fallback: cannot send value to fallback");
